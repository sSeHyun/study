...
<body>
	...
	<h3>request의 속성처리하기</h3>
	
	<%
		//http:://localhost:8080/jsp01_basic/jsp04_implict/jsp0407_scope.jsp?name=홍길동&age=1000
		//get방식은 한글은 안깨지지만 post방식일 경우 깨지기때문에 인코딩처리를 해야한다.
	...
	<h3>application의 속성처리하기</h3>
	<%
		application.setAttribute("xxx", name);
		application.setAttribute("yyy", request.getParameter("age"));
	%>
	회원 이름: <%= application.getAttribute("xxx") %>
	회원 나이: <%= application.getAttribute("yyy") %>
