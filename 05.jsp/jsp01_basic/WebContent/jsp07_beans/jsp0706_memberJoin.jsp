...
<% 
	...
	request.setAttribute("hong",member);		//member객체를 hong(request속성)으로 저장
	request.setAttribute("addr","조선한양");	//String객체를 addr 속성으로 저장
...
<body>
	...
	<%= ((MemberVO)request.getAttribute("hong")).getName() %> <br />
