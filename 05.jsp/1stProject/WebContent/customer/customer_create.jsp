...
<body>
	...
	<div class="container" align="center">
		...
		<form action="customerCreate.cs" method="post"  name="customerCreateForm">
			...
			<div class="form-group input-group">
				<div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-clipboard"></i></span></div>
				<input type="text" class="form-control" name="customer_addr" id="customer_addr"  required placeholder="서울시 강남구"/>
			</div>
			<div class="form-group input-group">
				<div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-clipboard"></i></span></div>
				<input type="text" class="form-control" name="customer_email" id="customer_email"  required placeholder="xxx@abcde.com"/>
			</div>
