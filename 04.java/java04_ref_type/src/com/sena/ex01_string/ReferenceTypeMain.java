...
public class ReferenceTypeMain {
	...
	public static void main(String[] args) {
		...
		ReferenceTypeMain myclass1 = new ReferenceTypeMain();
		com.sena.ex01_string.ReferenceTypeMain myclass2 = new com.sena.ex01_string.ReferenceTypeMain();
		...
		s4=null;							//s4에 할당된 객체는 쓰레기 객체(JVM gc(가비지컬렉터)가 임의의 시간에 메모리에서 삭제)
		...
		System.out.println("--------------------------------------------");
		//동등연산자
		System.out.println("name1==name2의 비교 결과: "+(name1==name2));
		System.out.println("name1==name3의 비교 결과: "+(name1==name3));
		System.out.println("--------------------------------------------");
